...
FORCE_CONTINUOUS = {
    'ADDSUG', 'Age', 'Alcohol % of cals (%)', 'B1, B2 (mg)', 'Beta-carotene (mcg)', 'Body Mass Index', 
    ...
    'Dietary Fiber(g)', 'Duration of MS', 'Expanded Disability Status Scale', 'FATTYACID', 'Fat (g)', 
    ...
    'Potassium (mg)', 'Protein (g)', 'Protein (g) as % of cals', 'REFINEDGRAIN', 'Number of relapses', 
    'Roommates', 'Prescription medication', 'rxmeds_number', 'Saturated fat (g)','Saturated fat (g) as % of cals',
    'SEAPLANT_PROT', 'SFA', 'SODIUM', 'Sodium (salt) (mg)', 'SPMS onset year', 'Sweets % of cals (%)', 
    'Vegetables group (cups)', 'Vitamdietpairsumin A (RAE)', 'TOTALDAIRY', 'TOTALFRUIT','TOTALVEG', 
    'TOTPROT', 'Vitamin B6 (mg)', 'Vitamin C (mg)', 'Vitamin D', 'Vitamin E (mg)',  'Weight', 
    'WHOLEFRUIT','WHOLEGRAIN', 'Whole grains (1)', 'without potatoes (cups)', 'MS Onset Year', 
    'Zinc (mg)',       
}
