...
if len(sys.argv) >= 3:
    ...
    variable1 = "default_var1"
    variable2 = "default_var2"
    print("No variables provided, using defaults")

# You can now use variable1 and variable2 in your analysis
# For example, you might use them to:
# - Filter data based on these variables
# - Modify binning parameters
# - Change visualization settings
# - etc.

# Example usage:
print(f"Processing with Variable 1: {variable1}")
print(f"Processing with Variable 2: {variable2}")
print(f"I'm here nowwwwwwwwww")
...
if not dataset_dir:
    print("ERROR: Could not find iMSMS_dataset directory!")
    print("Please ensure the iMSMS_dataset folder is in one of these locations:")
    for location in possible_dataset_locations:
...
print(f"Using dataset files from: {dataset_dir}")
print(f"S1_PATH: {S1_PATH}")
print(f"S2_PATH: {S2_PATH}")
print(f"S3_PATH: {S3_PATH}")
print(f"S6_PATH: {S6_PATH}")
